SCENE=$1
STYLE=$2
echo "Enter the Style image Indexes you want for your respective objects (space separated)"
read -a style_idxs

echo "Enter the COCO object Indexes you want to be styled (space separated)"
read -a class_idxs
...
python opt_style_embed.py -t ${ckpt_arf} ${data_dir} \
...
python render_imgs_embed.py ${ckpt_arf}/ckpt.npz ${data_dir} \
